...
# arguments ----
data_file <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/data/external_data/10X_data_integrated/liver_8754A_integrated.rds'

out_dir <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/results/snRNA_external_data/10X_data_Tony/integration/liver_8754A'
dir.create(out_dir, recursive = T)

sample_id <- 'liver_8754A'
...
markers <- c(
    'KRT8', 'KRT18', 'EGFR', 'MKI67', 'ESR1', 'TOP2A',
    'PDGFRA', 'PDGFRB', 'COL1A1', 'FAP', 'FAK',
    'ACTA2', 'MYH11', 'MYL9', 'MCAM', 'RGS5', 
    'PECAM1', 'VWF', 'FLT1', 'PROX1',
    'PTPRC', 'CD3D', 'CD2', 'TRAC', 'TRBC1', 'CD4', 'CD8A', 'FOXP3',
    'MS4A1', 'CD79A', 'CD19',
    'ITGAX', 'CD68', 'CD163', 'TNF', 'CD80', 'CD86', 'NOS2', 
    'CD14', 'CCR2', 'FCGR3A',
    'CLEC10A', 'CLEC9A', 'XCR1',
    'ITGAM',
    'NCAM1', 'NKG7',
    'HPX', 'AGSR1', 'CLEC4G', 'ONECUT1', 'KRT19',
    'LGR5',
    'SPTA1', 'HBB', 'HBA',
    'NRXN1', 'CADM2', 'NRXN3',
    'REG4', 'AFP', 'SLC18A1', 'LMX1A', 'TRPA1',
    'HGF', 'ANXA4', 'KRT7', 'DEFB1',
    'MARCO', 'CD5L', 'C1QB', 'C1QA', 'C1QC', 'MS4A7', 'CD163', 'FTL', 'CETP', 'VCAM1',
    'GPNMB', 'FABP5', 'LIPA', 'CD68',
    'S100A8', 'S100A9', 'FCN1', 'LYZ', 'VCAN', 'S100A12', 'LST1', 'S100A4', 'MNDA', 'CSTA',
    'CD33', 'CEACAM8', 'MPO',
    'THY1', 'CCL2', 'PTGDS', 'ELN', 'MFAP4', 'IGFBP7',
    'PRSS23', 'SELE', 'RSPO3', 'LXH6', 'RAMP3', 'LIFR',
    'CLEC14A', 'TM4SF1', 'ID1', 'PECAM1', 'DLL4')
...
new_annotation_df <- data.frame(cluster_id = unique(as.character(Idents(obj))),
                                initial_annotation = '')
new_annotation_df[new_annotation_df$cluster_id == '0', 'initial_annotation'] <- 'Hepatocytes'
new_annotation_df[new_annotation_df$cluster_id == '1', 'initial_annotation'] <- 'Hepatocytes'
new_annotation_df[new_annotation_df$cluster_id == '2', 'initial_annotation'] <- 'Hepatocytes'
new_annotation_df[new_annotation_df$cluster_id == '3', 'initial_annotation'] <- 'Hepatocytes'
new_annotation_df[new_annotation_df$cluster_id == '4', 'initial_annotation'] <- 'LSEC'
new_annotation_df[new_annotation_df$cluster_id == '5', 'initial_annotation'] <- 'Kupffer_cells'
new_annotation_df[new_annotation_df$cluster_id == '6', 'initial_annotation'] <- 'Hepatocytes'
new_annotation_df[new_annotation_df$cluster_id == '7', 'initial_annotation'] <- 'Other_macrophages'
new_annotation_df[new_annotation_df$cluster_id == '8', 'initial_annotation'] <- 'Portal_fibroblasts'
new_annotation_df[new_annotation_df$cluster_id == '9', 'initial_annotation'] <- 'Hepatocytes'
new_annotation_df[new_annotation_df$cluster_id == '10', 'initial_annotation'] <- 'T'
new_annotation_df[new_annotation_df$cluster_id == '11', 'initial_annotation'] <- 'Hepatocytes'
new_annotation_df[new_annotation_df$cluster_id == '12', 'initial_annotation'] <- 'Monocytes'
new_annotation_df[new_annotation_df$cluster_id == '13', 'initial_annotation'] <- 'Stellate_cells'
new_annotation_df[new_annotation_df$cluster_id == '14', 'initial_annotation'] <- 'Other_macrophages'
new_annotation_df[new_annotation_df$cluster_id == '15', 'initial_annotation'] <- 'unknown'
new_annotation_df[new_annotation_df$cluster_id == '16', 'initial_annotation'] <- 'Hepatocytes'
new_annotation_df[new_annotation_df$cluster_id == '17', 'initial_annotation'] <- 'Cholangiocytes'
new_annotation_df[new_annotation_df$cluster_id == '18', 'initial_annotation'] <- 'Other_endothelial'
new_annotation_df[new_annotation_df$cluster_id == '19', 'initial_annotation'] <- 'vSMC'
new_annotation_df[new_annotation_df$cluster_id == '20', 'initial_annotation'] <- 'NK'
new_annotation_df[new_annotation_df$cluster_id == '21', 'initial_annotation'] <- 'NKT'
new_annotation_df[new_annotation_df$cluster_id == '22', 'initial_annotation'] <- 'B'
new_annotation_df[new_annotation_df$cluster_id == '23', 'initial_annotation'] <- 'RBCs'
new_annotation_df[new_annotation_df$cluster_id == '24', 'initial_annotation'] <- 'Lymphatic_endothelial'
new_annotation_df[new_annotation_df$cluster_id == '25', 'initial_annotation'] <- 'Other_macrophages'
new_annotation_df[new_annotation_df$cluster_id == '26', 'initial_annotation'] <- 'Cholangiocytes'
new_annotation_df[new_annotation_df$cluster_id == '27', 'initial_annotation'] <- 'Cycling'
new_annotation_df[new_annotation_df$cluster_id == '28', 'initial_annotation'] <- 'Stellate_cells'
new_annotation_df[new_annotation_df$cluster_id == '29', 'initial_annotation'] <- 'Other_macrophages'
...
plot_order <- plot_mtx_long %>% 
    arrange(factor(cell_type, 
        levels = c(
            'Hepatocytes', 'Portal_fibroblasts', 'vSMC', 'Stellate_cells', 'B', 'Cholangiocytes',
            'Kupffer_cells', 'Other_macrophages', 'Monocytes', 'Lymphatic_endothelial', 'Other_endothelial', 
            'LSEC', 'T', 'NKT', 'NK', 'Cycling', 'unknown', 'RBCs'))) %>% 
    pull(annotation) %>% 
    unique()
