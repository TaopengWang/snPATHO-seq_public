...
# arguments ----
data_file <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/data/external_data/10X_data_integrated/ColonCRC_1328A_integrated.rds'

out_dir <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/results/snRNA_external_data/10X_data_Tony/integration/ColonCRC_1328A'
dir.create(out_dir, recursive = T)

sample_id <- 'ColonCRC_1328A'
...
new_annotation_df[new_annotation_df$cluster_id == '1', 'initial_annotation'] <- 'T_CD4'
new_annotation_df[new_annotation_df$cluster_id == '2', 'initial_annotation'] <- 'B'
new_annotation_df[new_annotation_df$cluster_id == '3', 'initial_annotation'] <- 'Plasmablasts'
new_annotation_df[new_annotation_df$cluster_id == '4', 'initial_annotation'] <- 'Macrophage'
...
new_annotation_df[new_annotation_df$cluster_id == '7', 'initial_annotation'] <- 'Monocyte'
new_annotation_df[new_annotation_df$cluster_id == '8', 'initial_annotation'] <- 'Plasmablasts'
new_annotation_df[new_annotation_df$cluster_id == '9', 'initial_annotation'] <- 'Endothelial'
new_annotation_df[new_annotation_df$cluster_id == '10', 'initial_annotation'] <- 'Fibroblasts'
new_annotation_df[new_annotation_df$cluster_id == '11', 'initial_annotation'] <- 'Smooth_muscle_cells'
new_annotation_df[new_annotation_df$cluster_id == '12', 'initial_annotation'] <- 'Plasmablasts'
new_annotation_df[new_annotation_df$cluster_id == '13', 'initial_annotation'] <- 'Pericytes'
new_annotation_df[new_annotation_df$cluster_id == '14', 'initial_annotation'] <- 'T_cycling'
new_annotation_df[new_annotation_df$cluster_id == '15', 'initial_annotation'] <- 'Macrophage'
new_annotation_df[new_annotation_df$cluster_id == '16', 'initial_annotation'] <- 'unknown'
new_annotation_df[new_annotation_df$cluster_id == '17', 'initial_annotation'] <- 'unknown'
new_annotation_df[new_annotation_df$cluster_id == '18', 'initial_annotation'] <- 'Neuron'
new_annotation_df[new_annotation_df$cluster_id == '19', 'initial_annotation'] <- 'Lymphatic_endothelial'
...
plot_order <- plot_mtx_long %>% 
    arrange(factor(cell_type, 
        levels = c(
            'Fibroblasts', 'Endothelial', 'Lymphatic_endothelial', 'Smooth_muscle_cells', 'Neuron', 
            'Pericytes', 'Monocyte', 'Macrophage', 'B', 'T_cycling', 'T_CD4', 'T_CD8', 'Plasmablasts', 'unknown'))) %>% 
    pull(annotation) %>% 
    unique()
