...
# arguments ----
data_file <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/data/external_data/10X_data_integrated/melanoma_7167A_integrated.rds'

out_dir <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/results/snRNA_external_data/10X_data_Tony/integration/melanoma_7167A'
dir.create(out_dir, recursive = T)

sample_id <- 'melanoma_7167A'
...
markers <- c(
    ...
    'DNAH12', 'DNAAF1', 'DNAH7',
    'PMEL', 'KRT5', 'KRT14', 'FABP5', 'APOE', 'TP63',
    'S100A9', 'CTSS', 'S100A8', 'LYZ', 'VCAN', 'S100A12', 'IL1B', 'CD14', 'G0S2', 'FCN1',
    'ADIPOQ', 'FABP4', 'LEP', 'PPARG', 'UCP1', 'CIDEA', 'PRDM16',
    'SOX10', 'MITF', 'DCT', 'MLANA', 'PMEL', 'TYR', 'TYRP1',
    'CD1A', 'CD207',
...
new_annotation_df <- data.frame(cluster_id = unique(as.character(Idents(obj))),
                                initial_annotation = '')
new_annotation_df[new_annotation_df$cluster_id == '0', 'initial_annotation'] <- 'Melanocytes'
new_annotation_df[new_annotation_df$cluster_id == '1', 'initial_annotation'] <- 'Melanocytes'
new_annotation_df[new_annotation_df$cluster_id == '2', 'initial_annotation'] <- 'Melanocytes'
new_annotation_df[new_annotation_df$cluster_id == '3', 'initial_annotation'] <- 'Melanocytes'
new_annotation_df[new_annotation_df$cluster_id == '4', 'initial_annotation'] <- 'Melanocytes'
new_annotation_df[new_annotation_df$cluster_id == '5', 'initial_annotation'] <- 'Myeloid'
new_annotation_df[new_annotation_df$cluster_id == '6', 'initial_annotation'] <- 'Keratinocytes'
new_annotation_df[new_annotation_df$cluster_id == '7', 'initial_annotation'] <- 'Melanocytes_cycling'
new_annotation_df[new_annotation_df$cluster_id == '8', 'initial_annotation'] <- 'Melanocytes'
new_annotation_df[new_annotation_df$cluster_id == '9', 'initial_annotation'] <- 'CAF'
new_annotation_df[new_annotation_df$cluster_id == '10', 'initial_annotation'] <- 'Melanocytes'
new_annotation_df[new_annotation_df$cluster_id == '11', 'initial_annotation'] <- 'Keratinocytes'
new_annotation_df[new_annotation_df$cluster_id == '12', 'initial_annotation'] <- 'Melanocytes'
new_annotation_df[new_annotation_df$cluster_id == '13', 'initial_annotation'] <- 'Melanocytes_cycling'
new_annotation_df[new_annotation_df$cluster_id == '14', 'initial_annotation'] <- 'Melanocytes'
new_annotation_df[new_annotation_df$cluster_id == '15', 'initial_annotation'] <- 'T'
new_annotation_df[new_annotation_df$cluster_id == '16', 'initial_annotation'] <- 'Melanocytes_heatshock_high'
new_annotation_df[new_annotation_df$cluster_id == '17', 'initial_annotation'] <- 'Endothelial'
new_annotation_df[new_annotation_df$cluster_id == '18', 'initial_annotation'] <- 'PVL'
new_annotation_df[new_annotation_df$cluster_id == '19', 'initial_annotation'] <- 'Melanocytes'
...
plot_order <- plot_mtx_long %>% 
    arrange(factor(cell_type, 
        levels = c(
            'Melanocytes_cycling', 'Melanocytes', 'Melanocytes_heatshock_high', 'Mast_cells',
            'T', 'PVL', 'CAF', 'Myeloid', 'Keratinocytes', 'Endothelial'))) %>% 
    pull(annotation) %>% 
    unique()
