...
# arguments ----
obj_file_path <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/data/external_data/10X_data_annotated/melanoma_7167A_annotated.rds'

batch_col_name <- 'processing_method'
batch <- 'snPATHO'
# snPATHO scFFPE

initial_out_dir <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/results/snRNA_external_data/10X_data_Tony/CNV/melanoma_7167A/melanocyte_only'
...
cell_types_to_exclude <- c('unknown', 'RBCs', 'Cycling', 'Unassigned', 'Keratinocytes')

gene_order_file <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/resources/Javier_gene_ordering_hg38_gencode_v27.txt'

ref_cell_types <- c('CAF', 'Macrophage', 'PVL', 'T_cycling', 'Neuron', 'RGS5+_PVL', 'Endothelial', 
    'Lymphatic_endothelial', 'Monocyte', 'B', 'T_CD4', 'T_CD8', 'Plasmablasts', 'Macrophages', 'SMCs',
    'CAF', 'Monocytes', 'pDC', 'Pericytes', 'Fibroblasts', 'Mixed_immune_cells', 'vSMC', 'Other_macrophages',
    'Stellate_cells', 'Kupffer_cells', 'Portal_fibroblasts', 'Other_endothelial', 'LSEC', 'NK', 'T', 'NKT',
    'Monocytes', 'Mast_cells', 'Myeloid', 'CAF_PVL')
