...
# arguments ----
data_dir <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/data/external_data/FHIL_Data/Aligned'

datasets <- c('Kidney_whole_cell')
...
out_dir <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/results/snRNA_external_data/FHIL_kidney'
...
for (ds in datasets) {
    ...
    obj <- CreateSeuratObject(counts, project = "FHIL_data", assay = "RNA")
    obj[["percent.mt"]] <- PercentageFeatureSet(obj, pattern = "^MT-")

    # populate metadata
    obj$dataset_id <- ds
    obj$processing_method <- 'scFFPE'
    obj$sample_id <- ds
