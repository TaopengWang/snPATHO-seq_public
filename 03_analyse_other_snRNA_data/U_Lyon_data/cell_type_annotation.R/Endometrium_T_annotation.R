...
# arguments ----
data_file <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/data/external_data/CRCL-Data_processed/endometrium_T_clustered.rds'

out_dir <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/results/snRNA_external_data/Cyril_data/endometrium_T'
dir.create(out_dir, recursive = T)

sample_id <- 'endometrium_T'
...
new_annotation_df[new_annotation_df$cluster_id == '5', 'initial_annotation'] <- 'Epithelial'
new_annotation_df[new_annotation_df$cluster_id == '6', 'initial_annotation'] <- 'Epithelial'
new_annotation_df[new_annotation_df$cluster_id == '7', 'initial_annotation'] <- 'Immune_cells'
new_annotation_df[new_annotation_df$cluster_id == '8', 'initial_annotation'] <- 'Epithelial'
new_annotation_df[new_annotation_df$cluster_id == '9', 'initial_annotation'] <- 'Pericytes'
new_annotation_df[new_annotation_df$cluster_id == '10', 'initial_annotation'] <- 'Endothelial'
new_annotation_df[new_annotation_df$cluster_id == '11', 'initial_annotation'] <- 'CAF'
...
plot_order <- plot_mtx_long %>% 
    arrange(factor(cell_type, 
        levels = c(
            'Epithelial', 'CAF', 'Immune_cells', 'Endothelial', 'Pericytes'))) %>% 
    pull(annotation) %>% 
    unique()
