...
# arguments ----
data_file <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/data/external_data/CRCL-Data_processed/ovary_T_clustered.rds'

out_dir <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/results/snRNA_external_data/Cyril_data/ovary_T'
...
new_annotation_df[new_annotation_df$cluster_id == '1', 'initial_annotation'] <- 'CAF'
...
new_annotation_df[new_annotation_df$cluster_id == '4', 'initial_annotation'] <- 'Plasmablasts'
new_annotation_df[new_annotation_df$cluster_id == '5', 'initial_annotation'] <- 'Plasmablasts'
new_annotation_df[new_annotation_df$cluster_id == '6', 'initial_annotation'] <- 'Lymphocytes'
new_annotation_df[new_annotation_df$cluster_id == '7', 'initial_annotation'] <- 'Epithelial'
new_annotation_df[new_annotation_df$cluster_id == '8', 'initial_annotation'] <- 'Epithelial'
new_annotation_df[new_annotation_df$cluster_id == '9', 'initial_annotation'] <- 'Neuron'
new_annotation_df[new_annotation_df$cluster_id == '10', 'initial_annotation'] <- 'Plasmablasts'
new_annotation_df[new_annotation_df$cluster_id == '11', 'initial_annotation'] <- 'Myeloid'
new_annotation_df[new_annotation_df$cluster_id == '12', 'initial_annotation'] <- 'Lymphocytes'
new_annotation_df[new_annotation_df$cluster_id == '13', 'initial_annotation'] <- 'Plasmablasts'
...
new_annotation_df[new_annotation_df$cluster_id == '16', 'initial_annotation'] <- 'Epithelial'
...
plot_order <- plot_mtx_long %>% 
    arrange(factor(cell_type, 
        levels = c(
            'Neuron', 'Lymphocytes', 'Myeloid', 'Endothelial', 'Plasmablasts',
            'Epithelial', 'CAF', 'Pericytes'))) %>% 
    pull(annotation) %>% 
    unique()
