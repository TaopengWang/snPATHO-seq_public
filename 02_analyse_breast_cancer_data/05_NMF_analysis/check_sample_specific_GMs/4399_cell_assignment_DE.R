...
out_dir <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/results/gene_module_analysis/4399_unique_GMs'
...
programs <- c('nmf_4399', 'nmf_hypoxia', 'nmf_cell_cycle', 'nmf_stress')
