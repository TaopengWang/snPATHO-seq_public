...
# aim ----
    # integrated cellbender filtered data from 4411
...
# load data ----
ffpe_obj <- readRDS(file = paste0(data_dir, '/', sample_id, 'FFPE', '.rds'))
...
markers <- c(
    ...
    'PKD1', 'PKD2', 'PKHD1', 'FGF19', 'FGF21', 'FGF23', 'FGFR1', 'FGFR2', 'FGFR3', 'FGFR4')
