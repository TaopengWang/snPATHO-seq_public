...
# arguments ----
obj_file_path <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/data/snPATHO_seq/25k_downsampled_processed_objs/integrated/4399_cellbender_filtered_integration_final_annotation.rds'
initial_out_dir <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/results/integration/25k_downsampled/cellbender/4399/cnv_HMM_res'
...
cell_types_to_exclude <- c('RBCs', 'Cholangiocyte', 'Hepatocyte', 'LSEC')

gene_order_file <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/resources/Javier_gene_ordering_hg38_gencode_v27.txt'

ref_cell_types <- c('Endothelial', 'Lymphatic_endothelial', 'Macrophage', 'CAF', 'PVL', 'Mixed_lymphocytes')
