...
# aim ----
    ...
    # use HMM i3 to predict CNV status
...
# arguments ----
obj_file_path <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/data/snPATHO_seq/25k_downsampled_processed_objs/integrated/4066_cellbender_filtered_integration_final_annotation.rds'
initial_out_dir <- '/share/ScratchGeneral/tonwan/projects/snPATHO-Seq/results/integration/25k_downsampled/cellbender/4066/cnv_HMM_res'

batch_col_name <- 'sample_id'
batch <- '4066SNAPFix'
# "4066FFPE"    "4066SNAPFix" "4066GEX"  
...
# also remove unwanted cancer population
# subset_data <- subset(subset_data, subset = new_annotation %in% c('Ca_0', 'Ca_3', 'Ca_5', 'Ca_7'), invert = TRUE)
