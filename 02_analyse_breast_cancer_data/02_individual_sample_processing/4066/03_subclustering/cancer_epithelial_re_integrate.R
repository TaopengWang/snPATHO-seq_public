...
subset_obj <- subset(obj, subset = initial_annotation %in% c('Epithelial_FLEX_high_2', 'Epithelial_1', 'Epithelial_2', 'Epithelial_FLEX_high_1'))
...
working_dir <- paste0(out_dir, '/', sample_id, '/', 'subclustering', '/', 'cancer_epithelial_reintegrated')
...
pdf(paste0(working_dir, '/', 'umap_batch_factors.pdf'))
    ...
    print(
        DimPlot(integrated_obj, reduction = "umap", group.by = 'initial_annotation')
    )
    print(
