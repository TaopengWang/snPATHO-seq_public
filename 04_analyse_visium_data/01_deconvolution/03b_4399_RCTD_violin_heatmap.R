...
plot_df$path_annotation <- factor(plot_df$path_annotation, 
    levels = c('bile_duct', 'blood_vessel', 'cancer_adjacent_liver', 'Mixed_cancer_and_liver', 'cancer', 'Mixed_cancer_and_stroma',
        'stroma', 'immune'))


plot_df$cell_types <- factor(plot_df$cell_types,
    levels = c('Cholangiocyte', 'Lymphatic_endothelial', 'LSEC', 'Hepatocyte', 'Epithelial_cancer', 
        'CAF', 'PVL', 'Endothelial', 'Macrophage', 'Mixed_lymphocytes'))
...
annotation_df <- arrange(annotation_df, factor(annotation_df$cell_types,
    levels = c('Epithelial_cancer', 'CAF', 'Mixed_lymphocytes', 'Endothelial', 'PVL', 'Macrophage', 'RBCs', 'Lymphatic_endothelial',
        'Hepatocyte', 'Cholangiocyte', 'LSEC')))
