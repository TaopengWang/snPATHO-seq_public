...
plot_df$path_annotation <- factor(plot_df$path_annotation, 
    levels = c('IDC', 'DCIS', 'Mixed_IDC_stroma', 'Mixed_DCIS_stroma', 'normal', 'stroma', 'immune', 'adipose_tissue'))

plot_df$cell_types <- factor(plot_df$cell_types,
    levels = c('Epithelial_cancer', 'Epithelial_luminal', 'Epithelial_basal', 'Myoepithelial',
        'CAF', 'PVL', 'Endothelial', 'Macrophage', 'T_cells', 'B_cells', 'MAST', 'DC'))
...
#     levels = c('Epithelial_luminal', 'Epithelial_cancer', 'PVL', 'Epithelial_basal', 'Endothelial',
#                 'CAF', 'Myoepithelial', 'DC', 'B_cells', 'Macrophage', 'MAST', 'T_cells')))
# plot_mtx <- plot_mtx[rownames(annotation_df), ]
annotation_df <- arrange(annotation_df, factor(annotation_df$cell_types,
    levels = c('Epithelial_cancer', 'Epithelial_luminal', 'Epithelial_basal', 'Myoepithelial', 'CAF', 'PVL', 
        'Endothelial', 'Macrophage', 'DC', 'T_cells', 'MAST', 'B_cells')))
plot_mtx <- plot_mtx[rownames(annotation_df), ]
